# source("global.R")
# source("R/Server.R")
from12_summary <- reactive({
  validate(need(exists("form7_8_10_11_12_final"),
                "form7_8_10_11_12_final not found (build it in global.R)"))
  
  df <- form7_8_10_11_12_final %>%
    dplyr::mutate(
  ...
  final <- fix_tranfer2 %>%
    ...
    dplyr::arrange(province_kh, district_kh, year) %>%
    dplyr::transmute(
